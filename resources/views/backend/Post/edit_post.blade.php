...
<div class="row">
  <div class="col-12">
    <div class="card-box">
      ...
      <div class="row">
        <div class="col-xl-12">
          <form action="{{ URL::to('/admin/post/update-post/'.$post->post_id) }}" method="POST"
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" value="{{ $post->post_title }}" name="post_title"
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" value="{{ $post->post_slug }}" name="post_slug" class=" title_product form-control"
                         id="">
                  @error('post_slug')
                  <span class="erorr text-danger"> {{ $message }} </span>
                  @enderror
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <select name="category_post_id" class="title_product form-control input-sm m-bot15">
                    ...
                    <option {{ $cate->category_post_id == $post->category_post_id ? "selected" : ''   }}
                            value="{{ $cate->category_post_id }}"> {{ $cate->category_post_name }}</option>
                    @endforeach
                  </select>
