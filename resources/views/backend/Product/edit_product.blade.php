...
<div class="row">
  <div class="col-12">
    <div class="card-box">
      ...
      <div class="row">
        <div class="col-xl-12">
          <form action="{{ URL::to('/admin/product/update-product/'.$product->product_id) }}" method="POST"
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <select name="category_id" class="title_product form-control input-sm m-bot15">
                    ...
                    <option {{ $product->category_id == $cate->category_id ? 'selected' : '' }}
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <select name="brand_id" class="title_product form-control input-sm m-bot15">
                    ...
                    <option {{ $product->brand_id == $bra->brand_id ? 'selected' : '' }} value="{{ $bra->brand_id }}">
                      {{ $bra->brand_name }}
                    </option>
                    @error('brand_id')
                    <span class="erorr text-danger"> {{ $message }} </span>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" value="{{ $product->product_sales }}" name="product_sales"
                         class=" title_product form-control" id="">
                </div>
                @error('product_sales')
                <span class="erorr text-danger"> {{ $message }} </span>
              ...
              <div class="col-md-6" id="add-image-file">
                <div class="mb-3">
                  ...
                  <img width="70px" src="{{ asset ('Backend/uploads/products/'.$product->product_images) }}">
                </div>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="title_product" for="">Event </label>
                  <input type="text" value="{{ $product->product_event }}" name="product_event"
                         class=" title_product form-control" id="">
                </div>
                @error('product_event')
                <span class="erorr text-danger"> {{ $message }} </span>
