								...
								<div class="category__image">
										<figure class="box__image ">
												<img class="lazyload zoom banner__image "
														data-src="{{ asset('Frontend/images/banner_category/unnamed(3).webp') }}" alt=" "
														loading="lazy">
										</figure>
										...
										@foreach ($product_DGD as $value)
												<div class="brand text-center">
														...
														<a href="{{ URL::to('/product-detail/' . $value->product_id) }}"
																...
																<div class="brand__title brand__title--sub mb-2">{{ $value->product_event }}
																</div>
																<figure class="box__image">
																		<img class="lazyload zoom banner__image "
				...
				<div class="category rounded bg-white">
						...
						<div class="category__content d-flex flex-nowrap align-items-stretch">
								<div class="category__image">
										<figure class="box__image ">
												<img class="lazyload zoom banner__image "
														data-src="{{ asset('Frontend/images/banner_category/unnamed(4).webp') }}" alt=" "
														loading="lazy">
										</figure>
				...
				<div class="category rounded bg-white">
						...
						<div class="category__content d-flex flex-nowrap align-items-stretch">
								<div class="category__image">
										<figure class="box__image ">
												<img class="lazyload zoom banner__image "
														data-src="{{ asset('Frontend/images/banner_category/unnamed.webp') }}" alt=" "
														loading="lazy">
										</figure>
				...
				<div class="category rounded bg-white">
						...
						<div class="category__content d-flex flex-nowrap align-items-stretch">
								<div class="category__image">
										<figure class="box__image ">
												<img class="lazyload zoom banner__image "
														data-src="{{ asset('Frontend/images/banner_category/unnamed(6).webp') }}" alt=" "
														loading="lazy">
										</figure>
