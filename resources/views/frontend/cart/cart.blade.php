            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="sl">
                    <div class="sl">
                      <button class="det" onchange="subtractQuantity()"><svg fill="none" viewBox="0 0 24 24" size="16"
                             class="css-1mzhsqx"
                      ...
                      <input type="number" class="hy inputNumber" value="{{ $value->quantity }}">
                      <button class="det" onchange="addQuantity()"><svg fill="none" viewBox="0 0 24 24" size="16"
                             class="css-1mzhsqx"
                             color="textPrimary" height="16"
                             width="16" xmlns="http://www.w3.org/2000/svg">
                          <path fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  <a class="delete-cart" href="{{ url('/delete-cart/'.$value->product_id) }}">Xóa</a>
