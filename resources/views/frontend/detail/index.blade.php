          ...
          <div class="col-md-7 pr-3">
            <div class="product__info pt-4">
              ...
              <div class="d-block mb-3">
                ...
                {{-- <button class="border btn btn-none  "> Thêm vào giỏ hàng</button> --}}
              </div>
        ...
        <div class="bg-white rounded">
          <div class="row ">
            ...
            <div class="col-md-4">
              ...
              <p class="read-more read__specifications js-show-modal-specifications" data-toggle="modal">Đọc thêm <i
