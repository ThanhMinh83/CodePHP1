  ...
  <div class="container">
    ...
    <div class="row mt-4">
      ...
      <div class="col-md-9">
        <div class="thong_tin">
          ...
          <div class="d-flex flex-row bd-highlight mb-3">
            <div class="p-0 bd-highlight"><img src="{{ asset ('frontend/images/avt.jpg') }}" alt=""> </div>
    ...
    <div class="row mt-5 mb-5">
      <div class="col-md-12 border p-3">
        ...
        <div class="form mb-5">
          <textarea name="" id="" cols="130" rows="3"
                    placeholder="Viết bình luận của bạn (Vui lòng gõ tiếng Việt có dấu)"></textarea>
          <button type="button" class=" mau btn ">Gửi câu hỏi ?</button>
        </div>
        <div class="media">
